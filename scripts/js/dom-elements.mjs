export function getElements() {
  return {
    ...
    uploadResultDialog: document.querySelector("#uploadResultDialog"),
    uploadResultTitle: document.querySelector("#uploadResultTitle"),
    uploadResultCloseButton: document.querySelector("#uploadResultCloseButton"),
    uploadResultDismissButton: document.querySelector("#uploadResultDismissButton"),
    uploadResultViewRowsButton: document.querySelector("#uploadResultViewRowsButton"),
    uploadResultMessage: document.querySelector("#uploadResultMessage"),
    uploadResultValues: document.querySelector("#uploadResultValues"),
